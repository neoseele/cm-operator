...
func main() {
	...
	if err != nil {
		klog.Fatalf("Error building prom clientset: %s", err.Error())
	}

	kubeInformerFactory := kubeinformers.NewSharedInformerFactory(kubeClient, time.Second*30)
	promInformerFactory := informers.NewSharedInformerFactory(promClient, time.Second*30)

	controller := NewController(kubeClient, promClient,
	...
	promInformerFactory.Start(stopCh)
